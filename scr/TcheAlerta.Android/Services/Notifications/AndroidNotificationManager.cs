    ...
    public class AndroidNotificationManager : INotificationManager
    {
        ...
        public void Show(string id, string title, string message)
        {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(AndroidApp.Context, channelId)
                ...
                .SetLargeIcon(BitmapFactory.DecodeResource(AndroidApp.Context.Resources, Resource.Drawable.abc_list_selector_background_transition_holo_light))
                .SetSmallIcon(Resource.Drawable.abc_list_selector_background_transition_holo_light)
